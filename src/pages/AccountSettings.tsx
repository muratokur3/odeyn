...
import { Camera, Loader2, Save, ArrowLeft, ShieldCheck, ChevronRight, Coins, Info } from 'lucide-react';
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-slate-800">
                        ...
                        <div className="space-y-4">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full py-3 mt-2 bg-slate-900 dark:bg-white text-white dark:text-black rounded-xl font-bold transition-all active:scale-95 disabled:opacity-50"
                            >
                                {loading ? 'Kaydediliyor...' : 'Kurları Sabitle'}
                            </button>
                        </div>
                    </div>
